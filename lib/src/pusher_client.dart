...
class PusherChannelsClient {
  ...
  Future<void> disconnect() => _delegate.disonnectManually();
  ...
  /// Force reconnect even if there is an active attempt for reconnection.
  Future<void> forceReconnect() => _delegate.reconnect();
}
